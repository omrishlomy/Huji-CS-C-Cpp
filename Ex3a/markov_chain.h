...
//get the size to allocate as input
//return a pointer to the allocation place
void *gen_memory_allocation(int allocation_size);
Node *node_memory_allocation(MarkovChain* markov_chain);
/**
...
//Checks if the word ends a sentence
